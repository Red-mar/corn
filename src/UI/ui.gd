...
func _on_player_state_changed(state):
	$Panel/AspectRatioContainer/CenterContainer/VBoxContainer/Label.text = state


func _on_player_pickup(inventory):
	$Panel/AspectRatioContainer/CenterContainer/VBoxContainer/Label2.text = inventory
